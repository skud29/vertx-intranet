package fr.ods.intranet.common;
...
public class BaseMicroserviceVerticle extends AbstractVerticle {
    ...
    private static final String LOG_EVENT_ADDRESS = "intranet-events.log";
    ...
    public void start() {
        ...
        circuitBreaker = CircuitBreaker.create(cbOptions.getString("name", "intranet-circuit-breaker"), vertx,
